  ...
  return (
    <div > 
      <AnimatedBackground animationName="gradientWave" theme="myCustomTheme" />
        <h1 className="pt-20 text-center font-normal font-sans text-4xl sm:text-lg md:text-xl lg:text-[8rem]">
          Iris&apos; {' '}
          ...
          <div className="min-h-[300px] flex items-center justify-center bg-cover bg-center relative">
            <div className="bg-white/20 backdrop-blur-lg rounded-xl p-10 my-30  sm:w-full md:w-2/4 mx-auto text-center shadow-lg border border-white/30">
